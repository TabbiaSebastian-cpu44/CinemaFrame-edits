 ...
 * Todos los iconos son originales — sin dependencias externas.
 * Uso: <Icon.Play size={20} color="currentColor" />
 */

const icon = (path, viewBox = "0 0 24 24") =>
  ({ size = 20, color = "currentColor", className = "", strokeWidth = 1.5 }) => (
    <svg
      width={size}
      height={size}
      viewBox={viewBox}
...
export const Icon = {
  ...
  ChevronD: icon(<><path d="M6 9l6 6 6-6"/></>),
  ChevronR: icon(<><path d="M9 18l6-6-6-6"/></>),

  // Reproducción
  Play:     icon(<><polygon points="5,3 19,12 5,21" fill="currentColor" stroke="none"/></>),
  Pause:    icon(<><rect x="6" y="4" width="4" height="16" fill="currentColor" stroke="none"/><rect x="14" y="4" width="4" height="16" fill="currentColor" stroke="none"/></>),
  Stop:     icon(<><rect x="4" y="4" width="16" height="16" rx="2" fill="currentColor" stroke="none"/></>),
  SkipF:    icon(<><polygon points="5,4 15,12 5,20" fill="currentColor" stroke="none"/><rect x="17" y="4" width="2" height="16" fill="currentColor" stroke="none"/></>),
  SkipB:    icon(<><polygon points="19,4 9,12 19,20" fill="currentColor" stroke="none"/><rect x="5" y="4" width="2" height="16" fill="currentColor" stroke="none"/></>),
  Volume:   icon(<><path d="M11 5L6 9H2v6h4l5 4V5z"/><path d="M15.54 8.46a5 5 0 010 7.07"/><path d="M19.07 4.93a10 10 0 010 14.14"/></>),
  Mute:     icon(<><path d="M11 5L6 9H2v6h4l5 4V5z"/><path d="M23 9l-6 6M17 9l6 6"/></>),
  Fullscreen: icon(<><path d="M8 3H5a2 2 0 00-2 2v3m18 0V5a2 2 0 00-2-2h-3m0 18h3a2 2 0 002-2v-3M3 16v3a2 2 0 002 2h3"/></>),
  ...
  Trash:    icon(<><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 01-2 2H7a2 2 0 01-2-2V6m3 0V4a1 1 0 011-1h4a1 1 0 011 1v2"/></>),
  ...
  // Editor
  Pen:      icon(<><path d="M12 19l7-7 3 3-7 7-3-3z"/><path d="M18 13l-1.5-7.5L2 2l3.5 14.5L13 18l5-5z"/><path d="M2 2l7.586 7.586"/><circle cx="11" cy="11" r="2"/></>),
  Brush:    icon(<><path d="M9.06 11.9l8.07-8.06a2.85 2.85 0 114.03 4.03l-8.06 8.08"/><path d="M7.07 14.94c-1.66 0-3 1.35-3 3.02 0 1.33-2.5 1.52-2 2.02 1 1 2.18 2.02 3.96 2.02 2.66 0 4.96-2.13 4.96-4.81A3.21 3.21 0 007.07 14.94z"/></>),
  Eraser:   icon(<><path d="M20 20H7L3 16l10.5-10.5a2 2 0 012.82 0l5.18 5.18a2 2 0 010 2.82L9 20"/><path d="M6.0 11l7 7"/></>),
  ...
  StarFill: icon(<><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" fill="currentColor" stroke="none"/></>),
  Heart:    icon(<><path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/></>),
  HeartFill:icon(<><path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z" fill="currentColor" stroke="none"/></>),
  ...
  // Media / Film
  Film:     icon(<><rect x="2" y="2" width="20" height="20" rx="2.18" ry="2.18"/><line x1="7" y1="2" x2="7" y2="22"/><line x1="17" y1="2" x2="17" y2="22"/><line x1="2" y1="12" x2="22" y2="12"/><line x1="2" y1="7" x2="7" y2="7"/><line x1="2" y1="17" x2="7" y2="17"/><line x1="17" y1="17" x2="22" y2="17"/><line x1="17" y1="7" x2="22" y2="7"/></>),
  Camera:   icon(<><path d="M23 19a2 2 0 01-2 2H3a2 2 0 01-2-2V8a2 2 0 012-2h4l2-3h6l2 3h4a2 2 0 012 2z"/><circle cx="12" cy="13" r="4"/></>),
  ...
  Clapboard:icon(<><path d="M20 2H4a2 2 0 00-2 2v16a2 2 0 002 2h16a2 2 0 002-2V4a2 2 0 00-2-2z"/><path d="M2 10h20"/><path d="M7 2v8"/><path d="M12 2v8"/><path d="M17 2v8"/></>),
  ...
  Sparkle:  icon(<><path d="M12 3v1m0 16v1M4.22 4.22l.7.7m12.16 12.16l.7.7M3 12h1m16 0h1M4.92 19.08l.7-.7M18.36 5.64l.7-.7"/><circle cx="12" cy="12" r="4"/></>),
  Zap:      icon(<><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" fill="currentColor" stroke="none"/></>),
};
